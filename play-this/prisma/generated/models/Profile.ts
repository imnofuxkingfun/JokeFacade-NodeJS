...
export type ProfileWhereInput = {
  ...
  idUser?: Prisma.IntFilter<"Profile"> | number
...
export type ProfileScalarWhereWithAggregatesInput = {
  ...
  idUser?: Prisma.IntWithAggregatesFilter<"Profile"> | number
...
export type ProfileOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idUser" | "displayName" | "dob" | "bio", ExtArgs["result"]["profile"]>
...
export interface ProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const profileWithIdUserOnly = await prisma.profile.findMany({ select: { idUser: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Profiles and only return the `idUser`
   * const profileWithIdUserOnly = await prisma.profile.createManyAndReturn({
   *   select: { idUser: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Profiles and only return the `idUser`
   * const profileWithIdUserOnly = await prisma.profile.updateManyAndReturn({
   *   select: { idUser: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProfileFieldRefs {
  readonly idUser: Prisma.FieldRef<"Profile", 'Int'>
