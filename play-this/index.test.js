//RUN WITH!!!  npm test  --experimental-vm-modules
...
test('should return all artists', async () => {
    ...
    expect(result.data.artists).toHaveLength(30);
    expect(result.data.artists).toEqual(
        expect.arrayContaining([
            expect.objectContaining({ id: "1", name: "Alex Botea", description: "Romanian artist blending hip-hop and pop." }),
            expect.objectContaining({ id: "2", name: "Young Thug", description: "Atlanta rapper and singer." }),
            expect.objectContaining({ id: "3", name: "Gunna", description: "Melodic trap artist from Atlanta." }),
            expect.objectContaining({ id: "4", name: "Playboi Carti", description: "Cloudy trap and avant vibes." }),
            expect.objectContaining({ id: "5", name: "TWRP", description: "Funk-fueled synthwave band." }),
            expect.objectContaining({ id: "6", name: "KMFDM", description: "Industrial pioneers." }),
            expect.objectContaining({ id: "7", name: "Ashnikko", description: "Alt-pop and hyperpop energy." }),
            expect.objectContaining({ id: "8", name: "LE SSERAFIM", description: "Bold K-pop group." }),
            expect.objectContaining({ id: "9", name: "Future", description: "Trap icon." }),
            expect.objectContaining({ id: "10", name: "Travis Scott", description: "Rapper and producer." }),
            expect.objectContaining({ id: "11", name: "Rosalía", description: "Flamenco-rooted pop innovator." }),
            expect.objectContaining({ id: "12", name: "Metro Boomin", description: "Producer architecting trap hits." }),
            expect.objectContaining({ id: "13", name: "Doja Cat", description: "Genre-bending rapper/singer." }),
            expect.objectContaining({ id: "14", name: "NewJeans", description: "Fresh K-pop collective." }),
            expect.objectContaining({ id: "15", name: "The Weeknd", description: "Alternative R&B trailblazer." }),
            expect.objectContaining({ id: "16", name: "Dan Avidan", description: "Vocalist featured with TWRP." }),
            expect.objectContaining({ id: "17", name: "Chappell Roan", description: "Genre-defying pop powerhouse." }),
            expect.objectContaining({ id: "18", name: "Lady Gaga", description: "Pop icon and innovator." }),
            expect.objectContaining({ id: "19", name: "Dave", description: "Grime and rap artist." }),
            expect.objectContaining({ id: "20", name: "The Smiths", description: "Iconic post-punk band." }),
            expect.objectContaining({ id: "21", name: "Morrissey", description: "The Smiths frontman." }),
            expect.objectContaining({ id: "22", name: "Johnny Marr", description: "The Smiths guitarist." }),
            expect.objectContaining({ id: "23", name: "Kendrick Lamar", description: "Grammy-winning rapper." }),
            expect.objectContaining({ id: "24", name: "J. Cole", description: "Conscious hip-hop artist." }),
            expect.objectContaining({ id: "25", name: "SZA", description: "Neo-soul and R&B singer." }),
            expect.objectContaining({ id: "26", name: "Tyler, The Creator", description: "Alternative hip-hop artist." }),
            expect.objectContaining({ id: "27", name: "Billie Eilish", description: "Alternative pop sensation." }),
            expect.objectContaining({ id: "28", name: "Ariana Grande", description: "Pop and R&B vocalist." }),
            expect.objectContaining({ id: "29", name: "Harry Styles", description: "Former One Direction member." }),
            expect.objectContaining({ id: "30", name: "Olivia Rodrigo", description: "Pop-rock songwriter." })
        ])
    );
});
